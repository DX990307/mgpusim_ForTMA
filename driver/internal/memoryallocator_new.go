...
// 	device.interLeave = numPages / 48
// 	device.pageRemining = numPages % 48
// 	device.reminingPageInIL = device.interLeave

// 	for i := 0; i < numPages; i++ {

// 		if device.currentAssignedGPU != device.nextActualGPUIndex {
// 			device.currentAssignedGPU = device.nextActualGPUIndex
// 			device.reminingPageInIL = device.interLeave
// 		}
